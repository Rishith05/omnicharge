...
@Component({
            ...
            <mat-tab label="Operators">
              <div class="tab-content">
                <div class="table-header">
                  ...
                  <button mat-flat-button class="gradient-btn-small" (click)="showOperatorForm = !showOperatorForm; editingOperator = null; operatorForm.reset()">
                  ...
                  <div class="inline-form glass-card slide-down">
                    ...
                    <form [formGroup]="operatorForm" (ngSubmit)="saveOperator()">
                      <div class="form-row">
                        ...
                        <button mat-raised-button color="primary" class="gradient-btn-small" type="submit" [disabled]="operatorForm.invalid">
                ...
                <div class="table-container">
                  <table mat-table [dataSource]="operatorsDataSource" class="custom-table">
                    ...
                    <ng-container matColumnDef="name"><th mat-header-cell *matHeaderCellDef>Name</th><td mat-cell *matCellDef="let o" class="fw-600">{{ o.name }}</td></ng-container>
                    <ng-container matColumnDef="code"><th mat-header-cell *matHeaderCellDef>Code</th><td mat-cell *matCellDef="let o"><span class="code-badge">{{ o.code }}</span></td></ng-container>
                    <ng-container matColumnDef="isActive"><th mat-header-cell *matHeaderCellDef>Status</th><td mat-cell *matCellDef="let o"><span class="status-badge" [class]="o.isActive ? 'active' : 'inactive'">{{ o.isActive ? 'Active' : 'Inactive' }}</span></td></ng-container>
                    <ng-container matColumnDef="actions">
                      <th mat-header-cell *matHeaderCellDef>Actions</th>
                      <td mat-cell *matCellDef="let o">
                        <button mat-icon-button class="action-btn edit" (click)="editOperator(o)" matTooltip="Edit">
                          <mat-icon>edit</mat-icon>
                        </button>
                        <button mat-icon-button class="action-btn" [class.toggle-on]="o.isActive" [class.toggle-off]="!o.isActive" (click)="toggleOperator(o)" [matTooltip]="o.isActive ? 'Deactivate' : 'Activate'">
                          <mat-icon>{{ o.isActive ? 'toggle_on' : 'toggle_off' }}</mat-icon>
                        </button>
                        <button mat-icon-button class="action-btn delete" (click)="deleteOperator(o)" matTooltip="Delete">
                          <mat-icon>delete</mat-icon>
                        </button>
                      </td>
                    </ng-container>
                    <tr mat-header-row *matHeaderRowDef="operatorColumns"></tr>
                    <tr mat-row *matRowDef="let row; columns: operatorColumns;" class="hover-row"></tr>
                  </table>
                  <mat-paginator #operatorPaginator
                ...
                <div class="table-header">
                  <div class="plans-header-left">
                    ...
                    <mat-form-field appearance="outline" class="operator-filter">
                      ...
                      <mat-select [value]="selectedOperatorId" (selectionChange)="onPlanOperatorChange($event.value)">
                  ...
                  <button mat-flat-button class="gradient-btn-small" (click)="showPlanForm = !showPlanForm; editingPlan = null; planForm.reset()" [disabled]="!selectedOperatorId">
                    ...
                    <form [formGroup]="planForm" (ngSubmit)="savePlan()">
                      <div class="form-grid">
                        <mat-form-field appearance="outline">
                          ...
                          <input matInput formControlName="name" placeholder="e.g. Hero Unlimited">
                        </mat-form-field>
                        <mat-form-field appearance="outline">
                        ...
                        <mat-form-field appearance="outline">
                          ...
                          <input matInput formControlName="validity" type="number" placeholder="28">
                        </mat-form-field>
                        <mat-form-field appearance="outline">
                        ...
                        <mat-form-field appearance="outline" class="full-width">
                          ...
                          <input matInput formControlName="description" placeholder="Unlimited calls + 100 SMS/day">
                        </mat-form-field>
                        <mat-form-field appearance="outline">
                      ...
                      <div class="form-actions">
                        <button mat-raised-button color="primary" class="gradient-btn-small" type="submit" [disabled]="planForm.invalid">
                          <mat-icon>save</mat-icon> {{ editingPlan ? 'Update Plan' : 'Create Plan' }}
                        </button>
                      </div>
                    </form>
                  </div>
                ...
                @if (selectedOperatorId) {
                  <div class="table-container">
                    <table mat-table [dataSource]="plansDataSource" class="custom-table">
                      ...
                      <ng-container matColumnDef="name"><th mat-header-cell *matHeaderCellDef>Name</th><td mat-cell *matCellDef="let p" class="fw-600">{{ p.name }}</td></ng-container>
                      <ng-container matColumnDef="price"><th mat-header-cell *matHeaderCellDef>Price</th><td mat-cell *matCellDef="let p" class="amount">₹{{ p.price }}</td></ng-container>
                      <ng-container matColumnDef="validity"><th mat-header-cell *matHeaderCellDef>Validity</th><td mat-cell *matCellDef="let p">{{ p.validity }} days</td></ng-container>
                      <ng-container matColumnDef="data"><th mat-header-cell *matHeaderCellDef>Data</th><td mat-cell *matCellDef="let p">{{ p.data }}</td></ng-container>
                      <ng-container matColumnDef="category"><th mat-header-cell *matHeaderCellDef>Category</th><td mat-cell *matCellDef="let p"><span class="code-badge">{{ p.category }}</span></td></ng-container>
                      <ng-container matColumnDef="isActive"><th mat-header-cell *matHeaderCellDef>Status</th><td mat-cell *matCellDef="let p"><span class="status-badge" [class]="p.isActive ? 'active' : 'inactive'">{{ p.isActive ? 'Active' : 'Inactive' }}</span></td></ng-container>
                      <ng-container matColumnDef="actions">
                        <th mat-header-cell *matHeaderCellDef>Actions</th>
                        <td mat-cell *matCellDef="let p">
                          <button mat-icon-button class="action-btn edit" (click)="editPlan(p)" matTooltip="Edit">
                            <mat-icon>edit</mat-icon>
                          </button>
                          <button mat-icon-button class="action-btn" [class.toggle-on]="p.isActive" [class.toggle-off]="!p.isActive" (click)="togglePlan(p)" [matTooltip]="p.isActive ? 'Deactivate' : 'Activate'">
                            <mat-icon>{{ p.isActive ? 'toggle_on' : 'toggle_off' }}</mat-icon>
                          </button>
                          <button mat-icon-button class="action-btn delete" (click)="deletePlan(p)" matTooltip="Delete">
                            <mat-icon>delete</mat-icon>
                          </button>
                        </td>
                      </ng-container>
                  ...
                  <div class="empty-state">
                    ...
                    <p>Select an operator from the dropdown to view and manage its recharge plans.</p>
                  </div>
                }
              </div>
            </mat-tab>
              ...
              <div class="tab-content">
                ...
                <div class="table-container">
                  <table mat-table [dataSource]="usersDataSource" class="custom-table">
                    ...
                    <ng-container matColumnDef="fullName"><th mat-header-cell *matHeaderCellDef>Name</th><td mat-cell *matCellDef="let u" class="fw-600">{{ u.fullName }}</td></ng-container>
                    <ng-container matColumnDef="email"><th mat-header-cell *matHeaderCellDef>Email</th><td mat-cell *matCellDef="let u" class="text-muted">{{ u.email }}</td></ng-container>
                    ...
                    <ng-container matColumnDef="isActive"><th mat-header-cell *matHeaderCellDef>Status</th><td mat-cell *matCellDef="let u"><span class="status-badge" [class]="u.isActive ? 'active' : 'inactive'">{{ u.isActive ? 'Active' : 'Disabled' }}</span></td></ng-container>
                    <ng-container matColumnDef="actions">
                      <th mat-header-cell *matHeaderCellDef>Actions</th>
                      <td mat-cell *matCellDef="let u">
                        <button mat-stroked-button [class]="u.isActive ? 'revoke-btn' : 'grant-btn'" (click)="toggleUserAccess(u)">
  ...
  styles: [`
    ...
    .admin-icon-wrapper mat-icon { font-size: 36px; width: 36px; height: 36px; color: white; }
    ...
    .stat-icon-wrapper mat-icon { font-size: 32px; width: 32px; height: 32px; }

    .purple-gradient { background: linear-gradient(135deg, #a855f7, #7e22ce); box-shadow: 0 8px 16px rgba(168,85,247,0.3); }
    .teal-gradient { background: linear-gradient(135deg, #2dd4bf, #0f766e); box-shadow: 0 8px 16px rgba(45,212,191,0.3); }
    .amber-gradient { background: linear-gradient(135deg, #fbbf24, #d97706); box-shadow: 0 8px 16px rgba(251,191,36,0.3); }
    ...
    .plans-header-left { display: flex; align-items: center; gap: 24px; }
    .operator-filter { width: 250px; margin: 0; }
    
    ::ng-deep .mat-mdc-form-field-subscript-wrapper { display: none; }
    ::ng-deep .mat-mdc-text-field-wrapper { background: rgba(0,0,0,0.2) !important; }
    ...
    ::ng-deep .mat-mdc-header-row { background: rgba(0,0,0,0.3); }
    ...
    .amount { font-weight: 700; color: #2dd4bf !important; }
    ...
    .status-badge.active { background: rgba(44,182,125,0.15); color: #2cb67d; border: 1px solid rgba(44,182,125,0.3); }
    .status-badge.inactive { background: rgba(229,49,112,0.15); color: #e53170; border: 1px solid rgba(229,49,112,0.3); }
    ...
    .action-btn.toggle-on { color: #2cb67d; }
    .action-btn.toggle-off { color: #94a3b8; }

    .revoke-btn { border-color: rgba(248,113,113,0.3) !important; color: #f87171 !important; border-radius: 20px; }
    .grant-btn { border-color: rgba(44,182,125,0.3) !important; color: #2cb67d !important; border-radius: 20px; }
    .revoke-btn:hover { background: rgba(248,113,113,0.1); }
    .grant-btn:hover { background: rgba(44,182,125,0.1); }
    ...
    .inline-form h4 {
      font-size: 18px; font-weight: 700; margin-bottom: 24px; color: white;
    }
    ...
    .empty-icon-wrapper mat-icon { font-size: 40px; width: 40px; height: 40px; color: var(--text-muted); }
    .empty-state h3 { font-size: 22px; font-weight: 700; margin: 0 0 12px 0; color: white; }
    .empty-state p { color: var(--text-muted); margin: 0; max-width: 400px; line-height: 1.6; }

    /* Animations */
    .slide-down { animation: slideDown 0.4s cubic-bezier(0.16, 1, 0.3, 1); }
    .slide-up { animation: slideUp 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.2s both; }
    .stagger-up > * { animation: slideUp 0.5s cubic-bezier(0.16, 1, 0.3, 1) both; }
...
export class AdminComponent implements OnInit, OnDestroy, AfterViewInit, HasUnsavedChanges {
  ...
  hasUnsavedChanges(): boolean {
    return (this.showOperatorForm && this.operatorForm.dirty) ||
    ...
    this.operatorService.getAllOperators()
      ...
      .subscribe({
        next: (d) => {
          ...
          let count = 0;
          d.forEach(op => {
            this.operatorService.getPlansByOperator(op.id)
              .pipe(takeUntil(this.destroy$))
              .subscribe({
                next: (plans) => {
                  count += plans.length;
  ...
  saveOperator(): void {
    ...
    if (this.editingOperator) {
      this.operatorService.updateOperator(this.editingOperator.id, data).subscribe({
        next: () => {
          this.snackBar.open('Operator updated!', 'Close', { duration: 3000, panelClass: ['success-snackbar'] });
          // Update local state
          const idx = this.operatorsDataSource.data.findIndex(o => o.id === this.editingOperator!.id);
          if (idx >= 0) {
        ...
        error: () => this.snackBar.open('Update failed', 'Close', { duration: 3000, panelClass: ['error-snackbar'] })
      });
    } else {
      this.operatorService.createOperator({ ...data, isActive: true }).subscribe({
        next: (newOp) => {
          this.snackBar.open('Operator created!', 'Close', { duration: 3000, panelClass: ['success-snackbar'] });
          // In mock mode, create a local operator
          const mockOp: Operator = {
            id: Math.floor(Math.random() * 10000),
            name: data.name, code: data.code, isActive: true,
        ...
        error: () => this.snackBar.open('Create failed', 'Close', { duration: 3000, panelClass: ['error-snackbar'] })
      });
    }
  }
  ...
  deleteOperator(op: Operator): void {
    ...
    this.operatorService.deleteOperator(op.id).subscribe({
      next: () => {
        ...
        this.snackBar.open('Operator deleted!', 'Close', { duration: 3000, panelClass: ['success-snackbar'] });
        this.cdr.markForCheck();
      },
      error: () => this.snackBar.open('Delete failed', 'Close', { duration: 3000, panelClass: ['error-snackbar'] })
    });
  }
  ...
  toggleOperator(op: Operator): void {
    ...
    this.operatorService.toggleOperatorStatus(op.id, newStatus).subscribe({
      next: (updatedOp) => {
        ...
        this.snackBar.open(`Operator ${newStatus ? 'activated' : 'deactivated'}!`, 'Close', { duration: 3000, panelClass: ['success-snackbar'] });
        this.cdr.markForCheck();
      },
      error: () => this.snackBar.open('Failed to update operator status', 'Close', { duration: 3000, panelClass: ['error-snackbar'] })
    });
  }
  ...
  savePlan(): void {
    ...
    if (this.editingPlan) {
      this.operatorService.updatePlan(this.selectedOperatorId, this.editingPlan.id, data).subscribe({
        next: () => {
          this.snackBar.open('Plan updated!', 'Close', { duration: 3000, panelClass: ['success-snackbar'] });
      ...
      this.operatorService.createPlan(this.selectedOperatorId, { ...data, isActive: true }).subscribe({
        next: (newPlan) => {
          this.snackBar.open('Plan created!', 'Close', { duration: 3000, panelClass: ['success-snackbar'] });
          const mockPlan: Plan = {
            id: Math.floor(Math.random() * 10000), operatorId: this.selectedOperatorId!,
            operatorName: opName, ...data, isActive: true,
            createdAt: new Date().toISOString(), updatedAt: new Date().toISOString()
          };
  ...
  editPlan(plan: Plan): void {
    ...
    this.planForm.patchValue({
      name: plan.name, price: plan.price, validity: plan.validity,
      data: plan.data, description: plan.description, category: plan.category
    });
  ...
  deletePlan(plan: Plan): void {
    ...
    this.operatorService.deletePlan(this.selectedOperatorId!, plan.id).subscribe({
      next: () => {
        ...
        this.totalPlans--;
        this.snackBar.open('Plan deleted!', 'Close', { duration: 3000, panelClass: ['success-snackbar'] });
        this.cdr.markForCheck();
      },
      error: () => this.snackBar.open('Delete failed', 'Close', { duration: 3000, panelClass: ['error-snackbar'] })
    });
  ...
  togglePlan(plan: Plan): void {
    ...
    this.operatorService.togglePlanStatus(this.selectedOperatorId!, plan.id, newStatus).subscribe({
      next: (updatedPlan) => {
        ...
        this.snackBar.open(`Plan ${newStatus ? 'activated' : 'deactivated'}!`, 'Close', { duration: 3000, panelClass: ['success-snackbar'] });
        this.cdr.markForCheck();
      },
      error: () => this.snackBar.open('Failed to update plan status', 'Close', { duration: 3000, panelClass: ['error-snackbar'] })
    });
  }
  ...
  get users() { return this.usersDataSource.data; }
  get operators() { return this.operatorsDataSource.data; }
  get operatorPlans() { return this.plansDataSource.data; }
