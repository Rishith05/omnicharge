    ...
    <div class="landing-page">
      ...
      <section class="hero-section">
        ...
        <div class="hero-content fade-in">
          <h1 class="hero-title">Instant Mobile <span class="gradient-text">Recharge</span></h1>
          <p class="hero-subtitle">
            Recharge any mobile number instantly. Auto-detect operator, choose a plan, and pay
          ...
          <mat-card class="number-card slide-up">
            <form [formGroup]="numberForm" class="number-form">
              <mat-form-field appearance="outline" class="number-field">
                ...
                @if (
                  numberForm.get('mobileNumber')?.hasError('required') &&
                  numberForm.get('mobileNumber')?.touched
                ) {
                  <mat-error>Mobile number is required</mat-error>
                }
                @if (
                  numberForm.get('mobileNumber')?.hasError('pattern') &&
                  numberForm.get('mobileNumber')?.touched
                ) {
              ...
              <button
                ...
                [disabled]="detecting || numberForm.invalid"
                class="detect-btn"
              >
                @if (detecting) {
  ...
  detectOperator(): void {
    ...
    this.operatorService.detectOperator(this.numberForm.value.mobileNumber).subscribe({
      ...
      error: (err) => {
        ...
        this.cdr.markForCheck();
        this.snackBar.open(
          err.error?.message || 'Could not detect operator. Please try again.',
          'Close',
