...
export const MOCK_PLANS: Record<number, Plan[]> = {
  ...
  2: [
    ...
    basePlan(
      ...
      28,
      '2 GB/day',
      'Unlimited calls + Disney+ Hotstar',
      'Entertainment',
    ),
    basePlan(
      203,
...
export const MOCK_NOTIFICATIONS: Notification[] = [
  {
    id: 1,
    userId: 1,
    title: 'Welcome to OmniCharge!',
    message: 'Start your first recharge today.',
    type: 'IN_APP',
    category: 'SYSTEM',
    isRead: true,
    metadata: null,
    createdDate: '2025-03-25T10:00:00',
