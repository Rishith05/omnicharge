...
public class GatewayAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        // If gateway headers are present, create authentication object
        // Only userId and userRole are required; email/mobile is optional
        if (userId != null && userRole != null) {
            log.debug("Authenticating user from gateway headers: userId={}, role={}, email/mobile={}",
