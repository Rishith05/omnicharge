...
public class PaymentService implements IPaymentService {
    ...
    public void init() {
        try {
            jdbcTemplate.execute("ALTER TABLE transactions DROP CONSTRAINT IF EXISTS transactions_payment_method_check");
            log.info("Successfully dropped transactions_payment_method_check constraint");
        } catch (Exception e) {
