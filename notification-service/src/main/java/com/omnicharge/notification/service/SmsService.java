...
public class SmsService implements ISmsService {
    ...
    public void sendSms(String mobileNumber, String message) {
        try {
            ...
            context.put("recipient", toNumber);
            context.put("twilioSid", twilioMessage.getSid());
            context.put("twilioStatus", twilioMessage.getStatus().toString());
            context.put("deliveryStatus", "SENT");
            publishBusinessLog("SMS_SENT", "SMS sent successfully via Twilio", context);
            ...
            Map<String, String> context = new HashMap<>();
            context.put("recipient", mobileNumber != null ? mobileNumber : "NULL");
            context.put("deliveryStatus", "FAILED");
            context.put("errorMessage", e.getMessage() != null ? e.getMessage() : "Unknown error");
            publishBusinessLog("SMS_FAILED", "SMS sending failed", context);
